 ...
 */
public class CarModelViewAdapter extends RecyclerView.Adapter<CarModelViewAdapter.ViewHolder>{

    private List<CarModelInfoDTO> carInfolist;
    private Context context;
    private Utilities utilities;
    private OnItemClickListener.OnItemClickCallback onItemClickCallback;
    public CarModelViewAdapter(Context context, List<CarModelInfoDTO> carInfolist, OnItemClickListener.OnItemClickCallback onItemClickCallback){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tvAddressName.setText(carInfolist.get(position).getCarModelName());
